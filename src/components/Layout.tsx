...
import { LayoutDashboard, Users, Send, Megaphone, CalendarDays, Building2, Settings as SettingsIcon, UserPlus, LogOut, Menu, X, Globe, CreditCard, Handshake, Star } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/testimonials', label: 'Testimonials', icon: Star, end: false },
