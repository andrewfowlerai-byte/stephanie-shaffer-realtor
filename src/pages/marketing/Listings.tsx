    ...
    <>
      <div className="max-w-6xl mx-auto px-5 sm:px-6 py-16 sm:py-20">
        ...
        <p className="mt-5 text-lg text-silver-600 max-w-2xl leading-relaxed">
          Homes I am representing across Northeast Ohio, updated from MLS Now. See something you like, or want me
          to keep an eye out for something specific? Reach out anytime.
        </p>
